...
namespace DirtDevil\PromoBanner\Model;

use DirtDevil\PromoBanner\Model\Banner\FileInfo;
...
class Banner extends \Magento\Framework\Model\AbstractModel
{
     ...
     * Banner cache tag
     */
    const CACHE_TAG = 'dirtdevil_banners_slider';
    ...
    {
        $this->_init('DirtDevil\PromoBanner\Model\ResourceModel\Banner');
    }
