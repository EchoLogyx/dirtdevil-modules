<?php
namespace DirtDevil\PromoBanner\Model\Banner;

use DirtDevil\PromoBanner\Model\ResourceModel\Banner\CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getMediaUrl()
    {
        $mediaUrl = $this->storeManager->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'dirtdevil/banners_slider/';
        return $mediaUrl;
    }
