...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu(
            'DirtDevil_PromoBanner::all_banners'
        )->addBreadcrumb(
    ...
    {
        return $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_read') || $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_create') || $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_update');
    }
}
