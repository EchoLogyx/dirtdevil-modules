...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('DirtDevil\PromoBanner\Model\Banner')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_update') || $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_create') || $this->_authorization->isAllowed('DirtDevil_PromoBanner::banner_delete');
    }
}
