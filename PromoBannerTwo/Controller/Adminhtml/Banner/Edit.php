...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu(
            'DirtDevil_PromoBannerTwo::all_banners'
        )->addBreadcrumb(
    ...
    {
        return $this->_authorization->isAllowed('DirtDevil_PromoBannerTwo::banner_read') || $this->_authorization->isAllowed('DirtDevil_PromoBannerTwo::banner_create') || $this->_authorization->isAllowed('DirtDevil_PromoBannerTwo::banner_update');
    }
}
