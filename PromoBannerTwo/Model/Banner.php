...
namespace DirtDevil\PromoBannerTwo\Model;

use DirtDevil\PromoBannerTwo\Model\Banner\FileInfo;
...
class Banner extends \Magento\Framework\Model\AbstractModel
{
     ...
     * Banner cache tag
     */
    const CACHE_TAG = 'dirtdevil_banners_slider_two';
    ...
    {
        $this->_init('DirtDevil\PromoBannerTwo\Model\ResourceModel\Banner');
    }
    ...
    public function getImageUrl($imageName = null)
    {
        ...
        $image = $imageName;
        if (!$image) {
            $image = $this->getData('promobanner_image');
        }
        if ($image) {
            if (is_string($image)) {
